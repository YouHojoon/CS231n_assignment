...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        w2 = np.random.randn(int(num_filters*input_dim[1]*input_dim[2]*0.25),hidden_dim) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        dx,dw,db = affine_relu_backward(dx,cache_list[1])
        grads['W2'] = dw + self.reg*W2
        grads['b2'] = db

        _,dw,db = conv_relu_pool_backward(dx,cache_list[0])
